    ...
    return (
        <div className='text-center px-4 sm:px-6 lg:px-8'>
            <div className='flex flex-col gap-5 my-10'>
                ...
                <p className='text-sm sm:text-base text-gray-600'>Find opportunities that match your skills and ambition.</p>
                <div className='flex w-full sm:w-[90%] md:w-[70%] lg:w-[50%] xl:w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-2 sm:gap-4 mx-auto'>
                    <input
                        type="text"
